...
public class FilePersistence implements InitFunc {
    ...
    // @Value读不到值 这里不知道为啥，加了@Component、@Value(不用static)读不到值
//    @Value("${spring.application.name}")
    private static String applicationName;

    @Value("${spring.application.name}")
    public void setApplicationName(String applicationName) {
        FilePersistence.applicationName = applicationName;
    }

    @Override
    public void init() throws Exception {
//        String ruleDir = System.getProperty("user.home") + "/sentinelrules/" + appcationName;
        String ruleDir = "D:\\work\\goodDemo\\springcloud-alibaba\\sentinelrules\\" + applicationName;
